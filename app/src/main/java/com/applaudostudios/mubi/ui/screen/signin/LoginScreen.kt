    ...
    Scaffold(topBar = {
        ...
        Column(
            ...
            CustomTextField(value = password, onValueChange = {
                password = it
            }, placeholder = "Password", leadingIcon = {
                Icon(
            ...
            VerticalSpace(24)
            MubiButton(text = "Login", buttonStyle = MubiButtonStyle(width = 1F)) {
                loginViewModel.userInput(
                    LoginAction.LoginUser(email, password)
                )
            }
